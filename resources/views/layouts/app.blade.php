    ...
    <body x-data="{ open: false, openSidebar: true }" class="relative h-auto font-sans antialiased">
        <div class="flex h-auto">
            ...
            <div class="flex flex-col w-full h-auto">
                <!-- Page Heading -->
                @isset($header)
                <header class="flex relative bg-white dark:bg-[#18181B]">
                    <!-- Sidebar Humberger -->
                    ...
                    <div class="flex float-right justify-end mr-5 w-full">
                        <div class="hidden float-right md:flex md:items-center md:gap-[5px]">
                            ...
                            <button class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 bg-white rounded-md border border-transparent transition duration-150 ease-in-out dark:text-gray-400 dark:bg-[#18181B] hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                        ...
                        <div class="hidden float-right md:flex md:items-center">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 dark:bg-[#18181B] bg-white rounded-md border border-transparent transition duration-150 ease-in-out dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                                ...
                                <x-slot name="content">
                                    ...
                                    <div class="h-[50px] border-t-[1px] border-b-[1px] dark:border-[#464649] mt-1">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <x-dropdown-link :href="route('logout')"
                                                onclick="event.preventDefault();
                                                            this.closest('form').submit();" class="flex gap-[5px] mt-1">
            ...
            <main class="flex flex-col justify-between h-auto bg-white dark:bg-gray-800">
                ...
                <div class="h-auto bg-white min-h-fit dark:bg-[#18181B]">
                    <div class="h-auto md:min-h-[calc(100vh-70px)] min-h-fit dark:bg-[#09090B] bg-[#ececec] p-[0px] md:p-[25px]  dark:border-gray-800 border-white rounded-xl">
                        <div class="h-auto min-h-screen md:min-h-[calc(100vh-120px)] rounded-xl border-2 dark:bg-[#18181B] dark:bg-opacity-50 bg-gray-100 border-[#5E93DA] shadow-lg p-[25px] ">
                            {{ $slot }}
                        </div>
                    </div>
                </div>
