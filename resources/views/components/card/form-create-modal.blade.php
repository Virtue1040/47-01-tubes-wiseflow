<x-card.shadow-bg>
    <div class="hidden w-[40px] h-[40px] border-4 rounded-full relative justify-center items-center" name="template1">
    ...
    <div class="w-auto h-auto min-w-[600px] bg-[#fafafa] dark:bg-[#18181B] rounded-3xl flex flex-col fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 dark:border-[#464649] border-gray-200 " name="modal">
        <div class="w-auto px-[35px] pb-[15px] h-[130px] border-b-2 border-[#EFEFEF] dark:border-[#222224] flex justify-center items-center" name="listStep">

        </div>
        <div class="w-auto h-auto  p-[25px] pt-[15px] rounded-b-3xl bg-white dark:bg-[#101013]">
            <div class="mt-1 w-auto min-w-[0px] flex flex-col min-h-[45px]" >
                <form id="modal_form" name="container" autocomplete="off" method="POST" action="" enctype="multipart/form-data">
